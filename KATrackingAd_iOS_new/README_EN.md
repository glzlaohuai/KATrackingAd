...
# Current Ver.3.7.8 [ReleaseNote](https://github.com/KATracking/KATrackingAd/blob/master/KATrackingAd_iOS_new/ReleaseNote.md)
...
* AppicSDK [download path](https://img.atomhike.com/sdk/Mediation/KASDK/KASDK.v3.7.8.zip)
