...
# 当前版本 Ver.3.7.13 [ReleaseNote](https://github.com/KATracking/KATrackingAd/blob/master/KATrackingAd_iOS_new/ReleaseNote.md)
# 接入说明
...
#### 广告SDK依赖库
* AppicSDK [下载链接](https://img.atomhike.com/sdk/Mediation/KASDK/KASDK.v3.7.13.zip)
